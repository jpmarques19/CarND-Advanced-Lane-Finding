...
def test_corners(fname):   
    """Draws corners on chessboard for testing purposes."""
...
def lane_find(img):
    ...
    return left_fitx, right_fitx, left_lane_inds, right_lane_inds, out_img, ploty,leftx_base, rightx_base

def draw_lanes(binary_warped,left_lane_inds, right_lane_inds,left_fitx, right_fitx,ploty):
